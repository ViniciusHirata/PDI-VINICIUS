...
SELECT prof, COUNT(*) AS quantidade
FROM pessoas
GROUP BY prof;
...
SELECT * FROM cursos WHERE idcurso = 6;
...
(default, '2014-01-01', '2', '4' ),
(default, '2016-12-22', '4', '1' );

select p.nome, a.idcurso, c.nome from pessoas as p
